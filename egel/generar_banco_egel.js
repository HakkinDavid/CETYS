...
const INPUT_FILES = [
  "preguntas_egel_compu_24.txt",
  "preguntas_egel_plus_24.txt",
  "preguntas_egel_ciencias_computacion.txt",
  "preguntas_guia_egel_compu_plus_temario_desarrollado_reactivos.txt",
];
